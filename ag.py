...
def SEND_MESSAGE(op):  
        ...
        if msg.contentType == 0:
            ...
            if agtxt.lower() == 'renew':
                ...
                restart_program()                
            if agtxt.lower() == wait["setkey"]+'mentionall' or agtxt.lower() == wait["setkey"]+' mentionall':
            ...
            if agtxt.lower() == wait["setkey"]+'lurk result' or agtxt.lower() == wait["setkey"]+' lurk result':
            ...
            if agtxt.lower() == wait["setkey"]+'lurk on' or agtxt.lower() == wait["setkey"]+' lurk on':
                if msg.to in wait2['readPoint']:
                    line.sendMessage(acorp, " 「 Lurk 」\nLurk already set♪")
                else:
                    try:
                    ...
                    backupjson_2()
                    line.sendMessage(acorp, " 「 Lurk 」\nLurk point set♪")
            if agtxt.lower() == wait["setkey"]+'lurk off' or agtxt.lower() == wait["setkey"]+' lurk off':
